...
public class TabletApplicationSettings
{	
	...
	public TabletApplicationSettings()
	{
	...
	//@Override
	public void render(GuiTablet gui, Minecraft mc, int x, int y, int mouseX, int mouseY, List<GuiButton> buttonList)
	{	
		if(gui.settingsOpen)
		{
